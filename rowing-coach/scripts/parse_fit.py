...
def _load_font(candidates, size):
    """Try font candidates in order, return first that works."""
...
def _draw_gradient(draw, width, height, top_color, mid_color, bot_color):
    """Draw vertical three-stop gradient."""
